...
contract BNum is BConst {
    ...
    /**
     * @notice Thrown when an invalid input is provided to bsqrt
     */
    error BNum_SqrtError();
    ...
    // TODO: Properly test this new function and add precision
    function bsqrt(uint256 x) internal pure returns (uint256) {
        unchecked {
            if (x == 0) return 0;

            // Need to multiply by BONE first to maintain precision
            uint256 z = (x * BONE + BONE) >> 1;
            uint256 y = x * BONE;
